...
namespace P4_1
{
    ...
    public class ClientHandler
    {
        ...
        private Action<string> updatePlayers;
        ...
        public ClientHandler(string address, Int32 port, string username, Action<string> a)
        {
            ...
            while (true)
            {
                ...
                try
                {
                    if (stream.Read(data, 0, data.Length) != 0)
                    {
                        ...
                        {
                            updatePlayers(Encoding.ASCII.GetString(data).Replace("\0", ""));
                        });
                    }
                }
                catch (Exception)
